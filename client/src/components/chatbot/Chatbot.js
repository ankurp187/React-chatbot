...
class Chatbot extends Component {
  ...
  _handleQuickReplyPayload(event,payload,text){
    ...
    switch (payload) {
      case 'recommend_yes': this.df_event_query('SHOW_RECOMMENDATIONS');
        break;
      ...
      return (
        <div style={{height:500,width:400,position:'absolute',bottom:0,right:0,border:'1px solid lightgrey'}}>
          ...
          <div className="col s12">
            <input style={{margin:0,paddingLeft:'1%',paddingRight:'1%',width:'98%'}} placeholder="Type your query" type="text" ref={(input) => {this.talkInput = input;}} onKeyPress={this._handleInputKeyPress} />
          </div>
        </div>
      )
    } else {
